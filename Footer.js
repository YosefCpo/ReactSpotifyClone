...
function Footer() {
	let [{footer_playlist}] = useDataLayerValue();

	return (
		<div className="footer">
			<div className="footer-info">
				{footer_playlist && <img alt="track-img" src={footer_playlist.img} />}
				<div className="footer-details">
					{footer_playlist && <h4>{footer_playlist.name}</h4>}
					{footer_playlist && <p>{footer_playlist.artists}</p>}
				</div>
			</div>
			<div className="footer-player">
				<div className={`options ${footer_playlist && "options-active"}`}>
					<svg
						role="img"
						height="16"
						width="16"
				...
				<div className="progress">
					...
					{footer_playlist ? <p>{footer_playlist.long}</p> : <p>0:00</p>}
				</div>
			</div>
